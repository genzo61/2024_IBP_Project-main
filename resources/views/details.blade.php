                            ...
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    @if ($product->sale_price)
                                        ${{$product->sale_price}}
                                    <del>${{$product->regular_price}}</del><span>{{round((($prodeuct->regular_price - $product->sale_price)/$prodeuct->regular_price)*100)}}
                                        % off</span>
                                    @else
                        ...
                        <div>
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{asset('shop.product.details',['slug'=>$rproduct->slug])}}">
                                    ...
                                    <div class="back">
                                        <a href="{{asset('shop.product.details',['slug'=>$rproduct->slug])}}">
                                            <img src="{{route('assets/images/fashion/product/back')}}/{{$rproduct->image}}"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="{{asset('shop.product.details',['slug'=>$rproduct->slug])}}" class="font-default">
                                            <h5>{{$rproduct->name}}</h5>
                                        </a>
                                        <div class="listing-content">
                                            <span class="font-light">{{$rproduct->category->name}}</span>
                                            <p class="font-light">{{$rproduct->short_describtion}}</p>
                                        </div>
