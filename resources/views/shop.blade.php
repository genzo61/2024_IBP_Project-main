                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands"
                                                        @if(in_array($brand->id,explode(',',$q_brands))) checked="checked" @endif value="{{$brand->id}}" type="checkbox" onchange="filterProductByBrands(this)">
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="ct{{$category->id}}" name="categories"
                                                    @if(in_array($category->id,explode(',',$q_categories))) checked="checked" @endif  type="checkbox" value="{{$category->id}}" onchange="filterProductByCategory(this)">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <div class="listing-content">
                                        ...
                                        <p class="font-light">{{$product->short_describtion}}</p>
                                    </div>
...
@push('scripts')
    <script>
        $(function(){
            ...
            instance = $range.data("İonRangeSlider");
            instance.update({
                from:{{$from}},
                to:{{$to}}
            });
                ...
                success:function(data){
                    if(data.status == 200){
                        ...
                        $.notify({
                            icon:"fa fa-check",
                            title:"success !",
                            message:"Item successfully added your wishlist"
                        });
                    }
                }
            });
